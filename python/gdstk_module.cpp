...
static PyTypeObject curve_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.Curve",
    .tp_basicsize = sizeof(CurveObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = curve_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject polygon_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.Polygon",
    .tp_basicsize = sizeof(PolygonObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = polygon_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject reference_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.Reference",
    .tp_basicsize = sizeof(ReferenceObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = reference_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject flexpath_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.FlexPath",
    .tp_basicsize = sizeof(FlexPathObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = flexpath_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject robustpath_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.RobustPath",
    .tp_basicsize = sizeof(RobustPathObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = robustpath_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject label_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.Label",
    .tp_basicsize = sizeof(LabelObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = label_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject repetition_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.Repetition",
    .tp_basicsize = sizeof(RepetitionObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = repetition_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject cell_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.Cell",
    .tp_basicsize = sizeof(CellObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = cell_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject rawcell_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.RawCell",
    .tp_basicsize = sizeof(RawCellObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = rawcell_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject library_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.Library",
    .tp_basicsize = sizeof(LibraryObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = library_object_type_doc,
    .tp_new = PyType_GenericNew,
};

static PyTypeObject gdswriter_object_type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "gdstk.GdsWriter",
    .tp_basicsize = sizeof(GdsWriterObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = gdswriter_object_type_doc,
    .tp_new = PyType_GenericNew,
};
