...
#pragma GCC diagnostic pop
    ...
    Repetition(const RepetitionType _type) {
        type = _type;
    }

    Repetition& operator = (Repetition&& _repetition) {
#ifdef linux
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wclass-memaccess"
#endif
        if (this == &_repetition) return *this;
        memcpy(this, &_repetition, sizeof(Repetition));
        memset(&_repetition, 0, sizeof(Repetition));
        return *this;
#ifdef linux
#pragma GCC diagnostic pop
#endif
    ...
    void get_offsets(std::vector<Vec2>& result) const;
